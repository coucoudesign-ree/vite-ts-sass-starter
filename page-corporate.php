...
<main>
      ...
      <div class="p-works__grid">
        ...
        <div class="p-works__item">
          ...
          <div class="p-works__item-inner">
            ...
            <p class="p-works__item-category">
              <?php echo esc_html(get_the_term_list(get_the_ID(), 'works_category', '', ' / ')); ?>
            </p>
          </div>
        </div>
        <?php
  ...
  <!-- ========================================
       FAQ（アコーディオン）
  ======================================== -->
  <section id="faq" class="l-section l-section--gray">
    <div class="l-container">
      <div class="p-section-header">
        <p class="p-section-label">FAQ</p>
        <h2 class="p-section-title">よくある質問</h2>
      </div>
      <div class="p-faq__list">
        ...
        <details class="c-accordion">
          ...
          <div class="c-accordion__body">
            <div class="c-accordion__content"><?php echo esc_html($item['a']); ?></div>
          </div>
        </details>
        <?php endforeach; ?>
      </div>
  ...
  <section id="contact" class="l-section">
    <div class="l-container">
      <div class="p-section-header">
        <p class="p-section-label">Contact</p>
      ...
      <div class="p-contact__inner">
        ...
        <form id="js-contact-form" class="c-form"
              action="<?php echo esc_url(get_template_directory_uri()); ?>/api/sendmail.php"
              method="post" novalidate>
          <input type="hidden" name="csrf_token" value="">

          <div class="c-form__honeypot" aria-hidden="true">
            <label for="nickname">名前</label>
            <input type="text" id="nickname" name="nickname" autocomplete="off" tabindex="-1">
          </div>

          <div class="c-form__group">
            <label for="name" class="c-form__label">お名前<span class="c-form__required">必須</span></label>
            <input type="text" id="name" name="name" class="c-form__input" placeholder="山田 太郎" autocomplete="name">
            <span id="name-error" class="c-form__error" role="alert" hidden></span>
          </div>

          <div class="c-form__group">
            <label for="furigana" class="c-form__label">フリガナ<span class="c-form__required">必須</span></label>
            <input type="text" id="furigana" name="furigana" class="c-form__input" placeholder="ヤマダ タロウ">
            <span id="furigana-error" class="c-form__error" role="alert" hidden></span>
          </div>

          <div class="c-form__group">
            <label for="email" class="c-form__label">メールアドレス<span class="c-form__required">必須</span></label>
            <input type="email" id="email" name="email" class="c-form__input" placeholder="example@email.com" autocomplete="email">
            <span id="email-error" class="c-form__error" role="alert" hidden></span>
          </div>

          <div class="c-form__group">
            <label for="tel" class="c-form__label">電話番号<span class="c-form__required">必須</span></label>
            <input type="tel" id="tel" name="tel" class="c-form__input" placeholder="03-1234-5678" autocomplete="tel">
            <span id="tel-error" class="c-form__error" role="alert" hidden></span>
          </div>

          <div class="c-form__group">
            <label class="c-form__label">ご住所<span class="c-form__required">必須</span></label>
            <div class="c-form__row">
              <div class="c-form__input-wrap">
                <input type="text" id="postcode" name="postcode" class="c-form__input"
                       placeholder="123-4567" maxlength="8" autocomplete="postal-code" aria-label="郵便番号">
                <span class="c-form__zip-status" aria-live="polite"></span>
                <span id="postcode-error" class="c-form__error" role="alert" hidden></span>
              </div>
              <div>
                <input type="text" id="address" name="address" class="c-form__input"
                       placeholder="都道府県・市区町村・番地" autocomplete="street-address" aria-label="住所">
                <span id="address-error" class="c-form__error" role="alert" hidden></span>
              </div>
            </div>
          </div>

          <div class="c-form__group">
            <label for="address_building" class="c-form__label">建物名・部屋番号<span class="c-form__optional">任意</span></label>
            <input type="text" id="address_building" name="address_building" class="c-form__input" placeholder="〇〇ビル 3F">
          </div>

          <div class="c-form__group">
            <label for="message" class="c-form__label">お問い合わせ内容<span class="c-form__required">必須</span></label>
            <textarea id="message" name="message" class="c-form__textarea" rows="6"
                      placeholder="ご相談内容をご記入ください"></textarea>
            <span id="message-error" class="c-form__error" role="alert" hidden></span>
          </div>

          <div data-form-alert class="c-form__alert" role="alert" hidden></div>

          <div class="c-form__group">
            <button type="submit" class="c-form__submit">送信する</button>
          </div>
        </form>
      </div>
    </div>
...
<!-- ページトップ -->
<a href="#" class="js-pagetop" aria-label="ページトップへ戻る">
